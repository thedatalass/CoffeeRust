...
__Data__: There are 337 observations for Brasil, Colombia and Papua New Guinea with five features: rain, temperature, rust, production amount and futures prices. Data Acquisition from multiple sources.
